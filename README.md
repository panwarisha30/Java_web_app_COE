...
9. Access the WeatherApp through your web browser using the provided URL (usually `http://localhost:8090/MyWeatherApp/`).
...
## Created by:
- [Isha Panwar](https://github.com/panwarisha30) 
